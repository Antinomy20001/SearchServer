...
int main()
{
    ...
    const char *index_key = "IDMap,Flat";
...

    {
        ...
        size_t nt;
        float *xt = fvecs_read("/home/lyf/data/sift/sift_learn.fvecs", &d, &nt);
...

    {
        ...
        size_t nb, d2;
        float *xb = fvecs_read("/home/lyf/data/sift/sift_base.fvecs", &d2, &nb);
        ...
        index->add_with_ids(nb, xb, xid.data());
...

    {
        ...
        size_t d2;
        xq = fvecs_read("/home/lyf/data/sift/sift_query.fvecs", &d2, &nq);
...

    {
        ...
        size_t nq2;
        int *gt_int = ivecs_read("/home/lyf/data/sift/sift_groundtruth.ivecs", &k, &nq2);
    ...
    { // run auto-tuning
        ...
        printf("[%.3f s] Preparing auto-tune criterion 1-recall at 1 "
               ...
               elapsed() - t0, k, nq);  //k=100  nq=10000
